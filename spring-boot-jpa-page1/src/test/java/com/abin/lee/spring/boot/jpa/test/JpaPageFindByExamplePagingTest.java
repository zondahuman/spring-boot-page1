 ...
 */
public class JpaPageFindByExamplePagingTest {

    private static final String httpURL = "http://localhost:8099/user/findByExamplePaging";

    @Test
    public void testJpaPageFindByExamplePaging() {
        try {
